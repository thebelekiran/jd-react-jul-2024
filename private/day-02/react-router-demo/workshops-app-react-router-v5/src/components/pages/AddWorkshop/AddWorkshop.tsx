...
import IWorkshop, { WorkshopCategory } from "../../../models/IWorkshop";
import Select from "react-select";

type SelectOption = { value: WorkshopCategory; label: string };

type FormData = Omit<IWorkshop, "id" | "category"> & {
...
const AddSession = () => {
    ...
    const addWorkshop = async (values: FormData) => {
        console.log("values = ", values);

        try {
            const addedWorkshop = await postWorkshop({
                ...values,
                category: values.category.value as WorkshopCategory, // we can be sure since it is validated
            });
            alert(
