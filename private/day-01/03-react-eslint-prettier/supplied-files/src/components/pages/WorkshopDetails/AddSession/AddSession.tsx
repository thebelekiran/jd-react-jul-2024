...
const AddSession = ({ id }: Props) => {
  ...
  const addSession = async (
    values: Omit<ISession, "id" | "workshopId" | "upvoteCount">,
  ) => {
    ...
    <div className="container my-4">
      ...
      <form onSubmit={handleSubmit(addSession)} noValidate>
        ...
        <div className="mb-3">
          ...
          {errors.speaker && (
            <small className="text-danger">
              {errors.speaker.type === "required" && "Speakers is required"}
        ...
        <div className="mb-3">
          ...
          {errors.level && (
            <small className="text-danger">
              {errors.level.type === "required" && "Level is required"}
            </small>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.abstract && (
            <small className="text-danger">
              {errors.abstract.type === "required" && "Abstract is required"}
            </small>
          )}
        </div>
